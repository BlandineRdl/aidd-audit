...
/**
 * The capability set a collector may publish, or `null` when the axis must stay unobserved.
 *
 ...
 * `project-brief.md` forbids outright. It costs only what this model can rank, since an
 * unrankable term hides nothing the report could have carried.
 */

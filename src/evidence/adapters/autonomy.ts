...
// repositories that is post-MVP. It is shared because the two production collectors are
// interchangeable by their port's promise, and a threshold the two read differently would break it.
